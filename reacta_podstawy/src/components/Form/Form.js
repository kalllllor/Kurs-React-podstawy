...
const Form = ({ submitFn }) => (
  <div className={styles.wrapper}>
    ...
    <form className={styles.form} onSubmit={submitFn}>
      ...
      <div className={styles.formItem}>
        <input className={styles.input} required type="text" name="link" id="link" placeholder=" " />
      ...
      <div className={styles.formItem}>
        <textarea className={styles.textarea} required name="description" id="description" placeholder=" " />
